...
class UserController {
    ...
    static async indexById (req: Request, res: Response) {
        try {
            ...
            const result = await UsersModel.findUserById(Number(id));
    ...
    static async save (req: Request, res: Response) {
        try {
            ...
            const result = await UsersModel.createNewUser(name, email, password);
    ...
    static async update (req: Request, res: Response) {
        try {
            ...
            const result = await UsersModel.updateUser(Number(id), name, email, password);
    ...
    static async delete (req: Request, res: Response) {
        try {
            ...
            const result = await UsersModel.deleteUser(Number(id));
